...
export default function Intro() {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-[#0e0e0e] to-[#1a1a1a] overflow-hidden px-4 font-inter">
      ...
      {/* Glassmorphic Card */}
      <div className="relative z-10 w-full max-w-xl mx-auto rounded-3xl border border-gray-800/40 bg-black/60 backdrop-blur-md shadow-xl shadow-gray-900/40 px-8 py-14 flex flex-col items-center gap-6">
